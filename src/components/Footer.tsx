            ...
            <div className="flex justify-between items-start mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 max-lg:flex-col max-lg:items-center max-lg:gap-10">
                ...
                <div className="flex flex-col items-end text-right max-lg:items-center max-lg:text-center">
                    ...
                    <div className="flex gap-4 mt-6">
                        ...
                        <Link href="https://www.facebook.com/profile.php?id=100063704340759" target="_blank" rel="noopener noreferrer" aria-label="Facebook Messenger" className="hover:scale-110 transition-transform active:scale-95">
                            <FaFacebookMessenger className="w-8 h-8 text-accent"></FaFacebookMessenger>
                        </Link>
                        <Link href="https://www.facebook.com/profile.php?id=100063704340759" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:scale-110 transition-transform active:scale-95">
